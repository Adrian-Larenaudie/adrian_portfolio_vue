    ...
    <div class="main_content_block_about">
        ...
        <div class="main_content_about_block_text">
            <p class="main_content_about_paragraph">
                C'est en 2021 que tout commence, après une période de quelques mois à me former aux téchnologies du web en autodidacte, je décide d'intégrer une école pour me professionnaliser.
            </p>
            <p class="main_content_about_paragraph">
            ...
            <p class="main_content_about_paragraph">
                Mes expériences m'ont amenées à comprendre et appliquer les concepts inhérents au développement applicatif et mon <span :style="{color: getCurrentTheme.word}">profile</span> s'oriente fullstack javascript.
            </p>
